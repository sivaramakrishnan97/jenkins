@CancelBooking
Feature: Verify OMRBranch Cancel Booking Details Automation

  @CancelBooking1
  Scenario Outline: Verify Cancel Order Id and verify cancel success message
    ...
    Examples: 
      ...
      | sivaraman.drs@gmail.com | 9677569677@Siva | Tamil Nadu | Chennai | Deluxe   | 2023-05-24 | 2023-05-25 | 1-One | 1-One  |     2 | Mr.        | Siva       | D         | 2145782145 | siva@123 | Credit card |

  @CancelBooking2
  Scenario Outline: Verify Change the booking and then cancel booking
    When User login "<username>" and "<password>"
    Then User should verify success message after login "Welcome Sivaramakrishnan"
    And user enters "<state>","<city>","<roomType>","<checkIn>","<checkOut>","<rooms>","<adults>" and "<child>"
    Then User should verify success message after Explore hotel "Select Hotel"
